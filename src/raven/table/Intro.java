...
public class Intro extends javax.swing.JPanel {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            JFrame AnnuaireFrame = new JFrame("Accueil | JOKKO");
    ...
    private void startServer() throws IOException {
        int port = 9001; // Choisissez un port approprié
        ...
        // serverSocket.close();
        JOptionPane.showMessageDialog(this, "Serveur démarré sur le port " + port, "Connexion reuissie", JOptionPane.INFORMATION_MESSAGE);
    }
...
public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                JFrame frame = new JFrame("Serveur | JOKKO"); // Create a JFrame
